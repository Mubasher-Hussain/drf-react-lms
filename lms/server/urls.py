...
urlpatterns = [
    ...
    path('api/book/createRating', views.RatingList.as_view(), name='add_rating'),
    path('api/book/updateRating', views.RatingChange.as_view(), name='update_rating'),
    ...
    path('api/set-password',views.set_password, name='set_pass'),
